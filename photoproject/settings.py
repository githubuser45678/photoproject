...
SECRET_KEY = 'django-insecure-=a_dk^9#852otix&i@pxn0rdq@4po2uyd2hwnhr-*wi1#p-&#d'
...
# メールサーバーへの接続設定
DEFAULT_FROM_EMAIL = 'utm2377093@stu.o-hara.ac.jp' # メールの送信元のアドレス
EMAIL_HOST = 'smtp.office365.com'                  # outlookのSMTPサーバー
EMAIL_PORT = 587                                   # outlookのポート番号
EMAIL_HOST_USER = 'utm2377093@stu.o-hara.ac.jp'    # outlookのアドレス
EMAIL_HOST_PASSWORD = 'Haruto-1723'                # outlookのパスワード
